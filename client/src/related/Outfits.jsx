      ...
      <>
        ...
        <div className="div_card_container">
          ...
          <div id="outfitSlider" className="div_slider">
            <div>
              <div className="div_addOutfit_card2" onClick={handlerAddClick}>
            ...
            <div>
              {
                  outfit.map((item) => {
                    ...
                    return (
                      <div key={item.id} className="div_outfit_card2">
                        ...
                        <div className="div_info_container">
                          ...
                          <br />
                          <div className="div_rating"><StarRating rating={helpers.configRatings(item.rating)} id="related_star" pixels={15} padding-bottom={5} /></div>
                        </div>
                      </div>
                    );
                  })
