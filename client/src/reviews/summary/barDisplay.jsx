      ...
      {element && (
        <>
          ...
          <div style={{ display: 'flex', justifyContent: 'left', alignItems: 'flex-start', marginTop: '-25px', position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', left: `${element}%`, marginLeft: '-1px', zIndex: 2 }}>
              <VerticalLine />
            </div>
          </div>
        </>
        ...
        <>
          ...
          <div style={{ display: 'flex', justifyContent: 'left', alignItems: 'flex-start', marginTop: '-25px', position: 'relative' }}>
            <div style={{ width: '100%', position: 'relative' }}>
              <HorizontalLine />
              <div style={{ fontSize: '12px', textAlign: 'left', marginTop: '-5px', marginLeft: '5px' }}>{lowRating}</div>
              <div style={{ fontSize: '12px', textAlign: 'right', marginTop: '-14px', marginRight: '5px' }}>{highRating}</div>
            </div>
            <div style={{ position: 'absolute', left: `${element}%`, top: '0', bottom: '0', marginLeft: '-1px', zIndex: 2 }}>
              <VerticalLine />
            </div>
          </div>
        </>
