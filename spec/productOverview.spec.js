    ...
    "results": [
      {
        ...
        "recommend": true,
        "response": null,
        "body": "asdfasdfasdfasdfasdfasdfasdfasdfasdfasdfsafasdfasdf",
        ...
        "photos": [
          {
            "id": 2456012,
            "url": "http://res.cloudinary.com/dzblbll9t/image/upload/v1662416371/qmhdwz9s2no78lk75ug1.jpg"
          },
          {
            "id": 2456013,
            "url": "http://res.cloudinary.com/dzblbll9t/image/upload/v1662416371/igokfqgvixb7jg77tq89.jpg"
          }
        ]
      },
      {
...
describe('ProductOverview', () => {
  test('renders ProductOverview component', () => {
    const { getByText } = render(<ProductOverview product={product} />);
